#!/usr/bin/env python3
"""Example Claude Code prompt hook template.

Exact Claude Code hook schemas can change. This script accepts plain stdin or
JSON input, scans locally, and blocks critical findings by exiting non-zero.
"""
